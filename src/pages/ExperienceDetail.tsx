...
const ExperienceDetail = () => {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center bg-[#FDFAF4]">
        <div className="text-center">
          ...
          <Link to="/experiences" style={{ fontFamily: "'Jost', sans-serif" }} className="text-[#C9A84C] underline">
            Back to Experiences
          </Link>
        </div>
      </div>
  ...
  // ============================================
  // BOOK NOW — cart mein add karo + seedha checkout pe bhej do
  // (Experiences ke liye sirf "booking" hai — shopping nahi)
  // ============================================
  const handleBookNow = () => {
    dispatch(addToCart({
      id: exp.id,
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:items-start">
          ...
          <div className="lg:sticky lg:top-[90px]">
            ...
            {/* What's Included */}
            <div className="bg-white rounded-2xl p-5 mt-6 shadow-[0_4px_16px_rgba(26,18,8,0.05)]">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span style={{ fontFamily: "'Jost', sans-serif" }} className="text-[0.78rem] text-[#9E8A6A]">({exp.reviews} reviews)</span>
            </div>
            ...
            {/* ============================================
                BOOKING BOX — date, time, guests + Book Now
            ============================================ */}
            <div className="bg-white rounded-2xl p-5 shadow-[0_4px_16px_rgba(26,18,8,0.06)]">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#FDFAF4] border border-[#EDE0C4] rounded-xl pl-9 pr-3 py-2.5 outline-none focus:border-[#C9A84C] transition-colors text-[#1A1208]"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <select
                    ...
                    style={{ fontFamily: "'Jost', sans-serif", fontSize: '0.8rem' }}
                    className="w-full bg-[#FDFAF4] border border-[#EDE0C4] rounded-xl px-3 py-2.5 outline-none focus:border-[#C9A84C] transition-colors text-[#1A1208]"
                  >
              ...
              <button
                ...
                className="w-full bg-[#C9A84C] text-white rounded-full py-4 text-[0.78rem] tracking-[0.2em] uppercase font-semibold hover:bg-[#1A1208] transition-colors"
              >
                Book This Experience
              </button>
              <p style={{ fontFamily: "'Jost', sans-serif" }} className="text-[0.68rem] text-[#9E8A6A] text-center mt-3">
                30% advance payment to confirm your booking
              </p>
            </div>
          </div>
        </div>
              ...
              {relatedExperiences.map((related) => (
                <StaggerItem key={related.id}>
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-[1.05rem] text-[#1A1208] font-semibold mb-1 leading-snug">
                        {related.title}
                      </h3>
                      <p style={{ fontFamily: "'Jost', sans-serif" }} className="text-[0.9rem] text-[#C9A84C] font-semibold">
                        From {formatPrice(related.price)}
                      </p>
                    </div>
                  </Link>
                </StaggerItem>
