...
const ShopDetail = () => {
      ...
      <div className="min-h-[60vh] flex items-center justify-center bg-[#FDFAF4]">
        <div className="text-center">
          <h2
            ...
            className="text-[2rem] text-[#1A1208] mb-4"
          >
            Product not found
          </h2>
          <Link
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      showToast({ message: `${item.title} added to cart with add-ons! 🎁` }),
    );
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2">
            <Link
              to="/shop"
              style={{ fontFamily: "'Jost', sans-serif" }}
              className="flex items-center gap-1 text-[0.78rem] text-[#9E8A6A] hover:text-[#C9A84C] transition-colors"
            >
            ...
            <span
              style={{ fontFamily: "'Jost', sans-serif" }}
              className="text-[0.78rem] text-[#9E8A6A]"
            >
              {item.category}
            </span>
            <span className="text-[#EDE0C4]">/</span>
            <span
              style={{ fontFamily: "'Jost', sans-serif" }}
              className="text-[0.78rem] text-[#D9776B]"
            >
              {item.title}
            </span>
          </div>
      ...
      <div className="container mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              <div className="bg-white rounded-xl p-3 flex items-center gap-2.5 shadow-[0_2px_8px_rgba(26,18,8,0.05)]">
                ...
                <div>
                  <p
                    style={{ fontFamily: "'Jost', sans-serif" }}
                    className="text-[0.75rem] text-[#1A1208] font-semibold"
                  >
                    Same Day Delivery
                  </p>
                  <p
                    style={{ fontFamily: "'Jost', sans-serif" }}
                    className="text-[0.65rem] text-[#9E8A6A]"
                  >
                    Order before 4 PM
                  </p>
                </div>
          ...
          <div>
            <p
              style={{ fontFamily: "'Jost', sans-serif" }}
              className="text-[0.65rem] text-[#D9776B] tracking-[0.25em] uppercase font-semibold mb-2"
            >
              {item.category} · {item.subcategory}
            </p>
            <h1
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
              className="text-[2rem] md:text-[2.6rem] text-[#1A1208] font-semibold leading-tight mb-4"
            >
              {item.title}
            </h1>
              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <FiStar
                    key={i}
                    size={14}
                    fill={i < Math.floor(item.rating) ? "#D9776B" : "none"}
                    color={i < Math.floor(item.rating) ? "#D9776B" : "#EDE0C4"}
                  />
                ))}
              </div>
              <span
            ...
            <p
              style={{ fontFamily: "'Jost', sans-serif" }}
              className="text-[0.85rem] text-[#5C4A1E] leading-relaxed mb-6"
            >
              {item.description}
            </p>
            ...
            <div className="mb-6">
              <h3
                style={{ fontFamily: "'Jost', sans-serif" }}
                className="text-[0.7rem] text-[#1A1208] font-semibold tracking-[0.15em] uppercase mb-3"
              >
                Quantity
              </h3>
              <div className="flex items-center gap-3 bg-white rounded-full px-4 py-2 w-fit shadow-[0_2px_8px_rgba(26,18,8,0.05)]">
                ...
                <span
                  style={{ fontFamily: "'Jost', sans-serif" }}
                  className="text-[0.9rem] text-[#1A1208] font-semibold w-6 text-center"
                >
                  {quantity}
                </span>
                <button
            ...
            <div className="mb-6">
              ...
              <p
                style={{ fontFamily: "'Jost', sans-serif" }}
                className="text-[0.65rem] text-[#9E8A6A] mt-1 text-right"
              >
...
============================================ */}
            <div className="bg-white rounded-2xl p-5 shadow-[0_4px_16px_rgba(26,18,8,0.05)] mb-6">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h3
                    style={{ fontFamily: "'Jost', sans-serif" }}
                    className="text-[0.72rem] text-[#1A1208] font-semibold tracking-[0.15em] uppercase"
                  >
                    Make It Extra Special
                  </h3>
                  <p
                    style={{ fontFamily: "'Jost', sans-serif" }}
                    className="text-[0.72rem] text-[#9E8A6A] mt-1"
                  >
                    Add a card, teddy bear, chocolates & more
                  </p>
                </div>
                <button
                  ...
                  {selectedAddOns.map((addOnId) => {
                    ...
                    return (
                      <div
                        key={addOnId}
                        style={{ fontFamily: "'Jost', sans-serif" }}
                        className="flex items-center gap-2 bg-[#FDFAF4] rounded-full pl-3 pr-1.5 py-1.5 text-[0.72rem] text-[#1A1208]"
                      >
                        {addOn.name}
                        <button
                          onClick={() => toggleAddOn(addOnId)}
                          className="w-5 h-5 rounded-full bg-[#EDE0C4] flex items-center justify-center hover:bg-[#D9776B] hover:text-white transition-colors"
                        >
                          <FiX size={11} />
                        </button>
                      </div>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-[0_4px_16px_rgba(26,18,8,0.06)]">
              ...
              <div className="space-y-2 mb-4 pb-4 border-b border-[#EDE0C4]">
                <div className="flex justify-between">
                  ...
                  <span
                    style={{ fontFamily: "'Jost', sans-serif" }}
                    className="text-[0.8rem] text-[#1A1208] font-medium"
                  >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  className="text-[1.8rem] text-[#1A1208] font-bold"
                >
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 rounded-full py-4 text-[0.78rem] tracking-[0.15em] uppercase font-semibold transition-all ${
                  added
                    ...
                    : "bg-[#C9A84C] text-white hover:bg-[#1A1208]"
                }`}
              >
                {added ? (
                  <>
        ...
        {relatedItems.length > 0 && (
          <div className="mt-16">
            <h2
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
              className="text-[1.8rem] text-[#1A1208] font-semibold mb-8"
            >
              You May Also Like
            </h2>
                ...
                <StaggerItem key={related.id}>
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3
                        style={{ fontFamily: "'Cormorant Garamond', serif" }}
                        className="text-[1rem] text-[#1A1208] font-semibold mb-1 leading-snug"
                      >
                        {related.title}
                      </h3>
                      <p
                        style={{ fontFamily: "'Jost', sans-serif" }}
                        className="text-[0.9rem] text-[#C9A84C] font-semibold"
                      >
