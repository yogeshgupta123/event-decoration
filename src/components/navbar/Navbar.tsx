...
const navLinks = [
  ...
  },
  {
    ...
    categories: [
      ...
      {
        title: "Special",
        items: ["Sugar Free", "Eggless", "Vegan", "Gluten Free", "Keto Cake"],
      },
      {
        title: "Mini Treats",
        items: [
  ...
  },
  {
    ...
    categories: [
      ...
      {
        title: "Outdoor",
        items: ["Rose Plant", "Jasmine", "Hibiscus", "Tulsi", "Bougainvillea"],
      },
      {
        title: "Gift Plants",
        items: [
    ...
    <div className="absolute top-[calc(100%+8px)] left-0 bg-white rounded-xl shadow-[0_12px_40px_rgba(26,18,8,0.15)] border border-[#EDE0C4] z-20 overflow-hidden w-[160px]">
      {cities.map((c) => (
          ...
          {c}
            ...
            <div className="flex md:hidden items-center gap-2">
              ...
              >
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#D9776B] text-white text-[8px] w-3.5 h-3.5 rounded-full flex items-center justify-center font-bold">
                    {cartCount}
                  </span>
                )}
              </Link> */}
          ...
          >
            {navLinks.map((link) => (
              ...
              >
                ...
                <FiChevronDown
                  size={11}
                  className={`transition-transform ${activeMenu === link.label ? "rotate-180" : ""}`}
                />
              </button>
            ))}
          </div>
        ...
        {activeMenu && (
          <MegaMenu
            categories={
              navLinks.find((l) => l.label === activeMenu)?.categories || []
            }
            label={activeMenu}
            ...
            <div>
              ...
              <div className="px-5 py-3 bg-[#FDFAF4] border-b border-[#EDE0C4] flex items-center gap-2">
                <span className="text-[1.2rem]">
                  {
                    navLinks.find((l) => l.label === activeMobileCategory)
                      ?.emoji
                  }
                </span>
                <span
              ...
              {navLinks
                .find((l) => l.label === activeMobileCategory)
                ?.categories.map((cat) => (
                  <div key={cat.title}>
